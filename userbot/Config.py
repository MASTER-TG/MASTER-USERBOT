...
if ENV:
    ...
    class Config(object):
        ...
        ALIVE_PIC = (
            ...
            or "https://te.legra.ph/file/f02cc84bf1ca448774592.jpg"
        )
        PM_PIC = (
        ...
        ALIVE_MSG = os.environ.get("ALIVE_MSG", None) or "Ｍ𝚊̃𝚜𝚝𝚎̐𝚛⚝𝙱𝚘̃𝚃 Is Online"
        PM_MSG = os.environ.get("PM_MSG", None)
        INSTANT_BLOCK = os.environ.get("INSTANT_BLOCK", "DISABLE")
        YOUR_GROUP = os.environ.get("YOUR_GROUP", "@Master_Userbot")
        YOUR_CHANNEL = os.environ.get("YOUR_CHANNEL", "@Official_MasterBot.")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/MASTER-TG/MASTERBOT"
        )
        APP_ID = os.environ.get("APP_ID", None)
        API_HASH = os.environ.get("API_HASH", None)
        MASTER_STRING = os.environ.get("LEGEND_STRING", None)
